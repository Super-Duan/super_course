...
if(objData.userName && objData.userPassword){
   ...
   if(objData.userName == "123" && objData.userPassword == "123"){
        wx.setStorageSync('isLogin', true);
        $this.setData({isLogin: true,user: "abc"});
        wx.setStorageSync('user', "abc");//登录者的名字 树洞页面要用到
        ...
        wx.switchTab({
          url: '../course/course'
            ...
            wx.showModal({title: '登录失败', content: '学号或密码错误!', showCancel: false});
        }
   }else{
       wx.hideToast();
       wx.setStorageSync('isLogin', false);
